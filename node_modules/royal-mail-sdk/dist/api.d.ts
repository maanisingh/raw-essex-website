...
/**
    ...
    * @enum {string}
    */
export declare enum CreateShipmentServiceOptionsServiceFormatEnum {
    L = "L",
    F = "F",
    P = "P",
    S = "S"
...
/**
    ...
    * @enum {string}
    */
export declare enum CreateShipmentServiceOptionsConsequentialLossEnum {
    Level1 = "Level1",
    Level2 = "Level2",
    Level3 = "Level3",
    Level4 = "Level4",
...
/**
    ...
    * @enum {string}
    */
export declare enum CreateShipmentServiceOptionsTrackingNotificationsEnum {
    Email = "Email",
    SMS = "SMS",
...
/**
    ...
    * @enum {string}
    */
export declare enum CreateShipmentShipmentInformationWeightUnitOfMeasureEnum {
    KG = "KG",
    Grams = "Grams"
}
/**
    ...
    * @enum {string}
    */
export declare enum CreateShipmentShipmentInformationProductEnum {
    NDX = "NDX",
    DOX = "DOX"
}
/**
    ...
    * @enum {string}
    */
export declare enum CreateShipmentShipmentInformationLabelFormatEnum {
    PDF = "PDF",
    PNG = "PNG",
...
/**
    ...
    * @enum {string}
    */
export declare enum CreateShipmentShipmentInformationShipmentActionEnum {
    Process = "Process",
    Allocate = "Allocate",
    Create = "Create"
}
...
/**
    ...
    * @enum {string}
    */
export declare enum ItemWeightUnitOfMeasureEnum {
    KG = "KG",
    Grams = "Grams"
}
/**
...
/**
    ...
    * @enum {string}
    */
export declare enum PackagingWeightUnitOfMeasureEnum {
    KG = "KG",
    Grams = "Grams"
}
/**
...
/**
    ...
    * @enum {string}
    */
export declare enum PrintDocumentRequestDocumentTypeEnum {
    CN23 = "CN23",
    CI = "CI",
    P = "P"
}
...
/**
    ...
    * @enum {string}
    */
export declare enum PrintDocumentResponseDocumentTypeEnum {
    CN23 = "CN23",
    CI = "CI",
    P = "P"
}
...
/**
    ...
    * @enum {string}
    */
export declare enum PrintLabelRequestLabelFormatEnum {
    PDF = "PDF",
    PNG = "PNG",
    DATASTREAM = "DATASTREAM",
    ZPL203DPI = "ZPL203DPI",
...
/**
    ...
    * @enum {string}
    */
export declare enum PrintLabelResponseLabelImageFormatEnum {
    PDF = "PDF",
    PNG = "PNG",
    DATASTREAM = "DATASTREAM",
    ZPL203DPI = "ZPL203DPI",
...
/**
    ...
    * @enum {string}
    */
export declare enum PrintLabelResponseReturnLabelImageFormatEnum {
    PDF = "PDF",
    PNG = "PNG",
    ZPL300DPI = "ZPL300DPI",
    ZPL203DPI = "ZPL203DPI"
...
/**
    ...
    * @enum {string}
    */
export declare enum ServiceAvailabilityFormatServiceFormatEnum {
    L = "L",
    F = "F",
    P = "P",
    S = "S"
...
/**
    ...
    * @enum {string}
    */
export declare enum ServiceAvailabilityResponseWeightUnitOfMeasureEnum {
    KG = "KG",
    Grams = "Grams"
}
/**
...
/**
    ...
    * @enum {string}
    */
export declare enum ServiceAvailabilityServiceOptionsServiceFormatEnum {
    L = "L",
    F = "F",
    P = "P",
    S = "S"
...
/**
    ...
    * @enum {string}
    */
export declare enum ServiceAvailabilityShipmentInformationWeightUnitOfMeasureEnum {
    KG = "KG",
    Grams = "Grams"
}
/**
    ...
    * @enum {string}
    */
export declare enum ServiceAvailabilityShipmentInformationProductEnum {
    NDX = "NDX",
    DOX = "DOX"
}
/**
...
/**
    ...
    * @enum {string}
    */
export declare enum ShipmentCancelRequestReasonForCancellationEnum {
...
/**
    ...
    * @enum {string}
    */
export declare enum ShipmentCreateResponseLabelImageFormatEnum {
    PDF = "PDF",
    PNG = "PNG",
    DATASTREAM = "DATASTREAM",
    ZPL203DPI = "ZPL203DPI",
...
/**
    ...
    * @enum {string}
    */
export declare enum ShipmentCreateResponseReturnLabelImageFormatEnum {
    PDF = "PDF",
    PNG = "PNG",
    ZPL300DPI = "ZPL300DPI",
    ZPL203DPI = "ZPL203DPI"
...
export declare const AddressesApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    addressesCreate: (xRMGAuthToken: string, address: Address, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    addressesDelete: (xRMGAuthToken: string, addressId: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    addressesGet: (xRMGAuthToken: string, addressId: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    addressesGetAll: (xRMGAuthToken: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    addressesUpdate: (xRMGAuthToken: string, addressId: string, address: Address, options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const AddressesApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    addressesCreate(xRMGAuthToken: string, address: Address, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AddressResponse>>;
    /**
     * Deletes the specified address.
     * @summary Delete Address
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @throws {RequiredError}
     */
    addressesDelete(xRMGAuthToken: string, addressId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AddressResponse>>;
    /**
     * Get the address specified by your unique Address ID.
     * @summary Get Address
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @throws {RequiredError}
     */
    addressesGet(xRMGAuthToken: string, addressId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Address>>;
    /**
     * Get all of your stored addresses
     * @summary Get Addresses
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @throws {RequiredError}
     */
    addressesGetAll(xRMGAuthToken: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Address>>>;
    /**
     * Update an address that is already in your address book with new details. The whole address will be replaced with<br />new details.
     * @summary Update address
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @throws {RequiredError}
     */
    addressesUpdate(xRMGAuthToken: string, addressId: string, address: Address, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AddressResponse>>;
};
/**
...
export declare class AddressesApi extends BaseAPI {
     ...
     */
    addressesCreate(xRMGAuthToken: string, address: Address, options?: any): Promise<import("axios").AxiosResponse<AddressResponse>>;
    /**
     * Deletes the specified address.
     * @summary Delete Address
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @memberof AddressesApi
     */
    addressesDelete(xRMGAuthToken: string, addressId: string, options?: any): Promise<import("axios").AxiosResponse<AddressResponse>>;
    /**
     * Get the address specified by your unique Address ID.
     * @summary Get Address
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @memberof AddressesApi
     */
    addressesGet(xRMGAuthToken: string, addressId: string, options?: any): Promise<import("axios").AxiosResponse<Address>>;
    /**
     * Get all of your stored addresses
     * @summary Get Addresses
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @memberof AddressesApi
     */
    addressesGetAll(xRMGAuthToken: string, options?: any): Promise<import("axios").AxiosResponse<Address[]>>;
    /**
     * Update an address that is already in your address book with new details. The whole address will be replaced with<br />new details.
     * @summary Update address
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @memberof AddressesApi
     */
    addressesUpdate(xRMGAuthToken: string, addressId: string, address: Address, options?: any): Promise<import("axios").AxiosResponse<AddressResponse>>;
}
/**
...
export declare const ItemsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    itemsCreate: (xRMGAuthToken: string, item: Item, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    itemsDelete: (xRMGAuthToken: string, itemId: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    itemsGet: (xRMGAuthToken: string, itemId: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    itemsGetAll: (xRMGAuthToken: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    itemsUpdate: (xRMGAuthToken: string, itemId: string, item: Item, options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const ItemsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    itemsCreate(xRMGAuthToken: string, item: Item, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ItemResponse>>;
    /**
     * Deletes the specified item.
     * @summary Delete Item
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @throws {RequiredError}
     */
    itemsDelete(xRMGAuthToken: string, itemId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ItemResponse>>;
    /**
     * Get the item specified by your unique Item ID.
     * @summary Get Item
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @throws {RequiredError}
     */
    itemsGet(xRMGAuthToken: string, itemId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Item>>;
    /**
     * Get all of your stored items
     * @summary Get Items
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @throws {RequiredError}
     */
    itemsGetAll(xRMGAuthToken: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Item>>>;
    /**
     * Update an item that is already stored with new details. The whole item will be replaced with new details.
     * @summary Update item
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @throws {RequiredError}
     */
    itemsUpdate(xRMGAuthToken: string, itemId: string, item: Item, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ItemResponse>>;
};
/**
...
export declare class ItemsApi extends BaseAPI {
     ...
     * @memberof ItemsApi
     */
    itemsCreate(xRMGAuthToken: string, item: Item, options?: any): Promise<import("axios").AxiosResponse<ItemResponse>>;
    /**
     * Deletes the specified item.
     * @summary Delete Item
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @memberof ItemsApi
     */
    itemsDelete(xRMGAuthToken: string, itemId: string, options?: any): Promise<import("axios").AxiosResponse<ItemResponse>>;
    /**
     * Get the item specified by your unique Item ID.
     * @summary Get Item
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @memberof ItemsApi
     */
    itemsGet(xRMGAuthToken: string, itemId: string, options?: any): Promise<import("axios").AxiosResponse<Item>>;
    /**
     * Get all of your stored items
     * @summary Get Items
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @memberof ItemsApi
     */
    itemsGetAll(xRMGAuthToken: string, options?: any): Promise<import("axios").AxiosResponse<Item[]>>;
    /**
     * Update an item that is already stored with new details. The whole item will be replaced with new details.
     * @summary Update item
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @memberof ItemsApi
     */
    itemsUpdate(xRMGAuthToken: string, itemId: string, item: Item, options?: any): Promise<import("axios").AxiosResponse<ItemResponse>>;
}
/**
...
export declare const ManifestsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    manifestsCreate: (xRMGAuthToken: string, request: ManifestRequest, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    manifestsCreateByCarrier: (xRMGAuthToken: string, request: ManifestCarrierCodesRequest, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    manifestsCreateByService: (xRMGAuthToken: string, request: ManifestServiceCodesRequest, options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const ManifestsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    manifestsCreate(xRMGAuthToken: string, request: ManifestRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ManifestResponse>>;
    /**
     * Manifest shipments created with the given carrier codes that are ready to manifest for a single Posting Location.<br />            <br />Required to confirm parcels are ready to despatch.<br />Generates the required paperwork to despatch your parcels. <br />One or more manifests, including the base 64 encoded PDF and manifest number will be returned.<br />            <br />*Note: All average weight shipments are ignored and need to be closed out via Shipment Processing*
     * @summary Manifest by Carrier Code(s)
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @throws {RequiredError}
     */
    manifestsCreateByCarrier(xRMGAuthToken: string, request: ManifestCarrierCodesRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ManifestResponse>>;
    /**
     * Manifest shipments created with the given service codes that are ready to manifest for a single Posting Location.<br />            <br />Required to confirm parcels are ready to despatch.<br />Generates the required paperwork to despatch your parcels. <br />One or more manifests, including the base 64 encoded PDF and manifest number will be returned.<br />            <br />*Note: All average weight shipments are ignored and need to be closed out via Shipment Processing*
     * @summary Manifest by Service Code(s)
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @throws {RequiredError}
     */
    manifestsCreateByService(xRMGAuthToken: string, request: ManifestServiceCodesRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ManifestResponse>>;
};
/**
...
export declare class ManifestsApi extends BaseAPI {
     ...
     */
    manifestsCreate(xRMGAuthToken: string, request: ManifestRequest, options?: any): Promise<import("axios").AxiosResponse<ManifestResponse>>;
    /**
     * Manifest shipments created with the given carrier codes that are ready to manifest for a single Posting Location.<br />            <br />Required to confirm parcels are ready to despatch.<br />Generates the required paperwork to despatch your parcels. <br />One or more manifests, including the base 64 encoded PDF and manifest number will be returned.<br />            <br />*Note: All average weight shipments are ignored and need to be closed out via Shipment Processing*
     * @summary Manifest by Carrier Code(s)
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @memberof ManifestsApi
     */
    manifestsCreateByCarrier(xRMGAuthToken: string, request: ManifestCarrierCodesRequest, options?: any): Promise<import("axios").AxiosResponse<ManifestResponse>>;
    /**
     * Manifest shipments created with the given service codes that are ready to manifest for a single Posting Location.<br />            <br />Required to confirm parcels are ready to despatch.<br />Generates the required paperwork to despatch your parcels. <br />One or more manifests, including the base 64 encoded PDF and manifest number will be returned.<br />            <br />*Note: All average weight shipments are ignored and need to be closed out via Shipment Processing*
     * @summary Manifest by Service Code(s)
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @memberof ManifestsApi
     */
    manifestsCreateByService(xRMGAuthToken: string, request: ManifestServiceCodesRequest, options?: any): Promise<import("axios").AxiosResponse<ManifestResponse>>;
}
/**
...
export declare const PackagingApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    packagingCreate: (xRMGAuthToken: string, packaging: Packaging, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    packagingDelete: (xRMGAuthToken: string, packagingId: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    packagingGet: (xRMGAuthToken: string, packagingId: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    packagingGetAll: (xRMGAuthToken: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    packagingUpdate: (xRMGAuthToken: string, packagingId: string, packaging: Packaging, options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const PackagingApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    packagingCreate(xRMGAuthToken: string, packaging: Packaging, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PackagingResponse>>;
    /**
     * Deletes the specified packaging.
     * @summary Delete Packaging
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @throws {RequiredError}
     */
    packagingDelete(xRMGAuthToken: string, packagingId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PackagingResponse>>;
    /**
     * Get the packaging details specified by your unique Packaging ID.
     * @summary Get Packaging
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @throws {RequiredError}
     */
    packagingGet(xRMGAuthToken: string, packagingId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Packaging>>;
    /**
     * Get all of your stored packaging details
     * @summary Get All Packaging
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @throws {RequiredError}
     */
    packagingGetAll(xRMGAuthToken: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Packaging>>>;
    /**
     * Update packaging details that is already stored with new details. All details will be replaced with new details.
     * @summary Update packaging
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @throws {RequiredError}
     */
    packagingUpdate(xRMGAuthToken: string, packagingId: string, packaging: Packaging, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PackagingResponse>>;
};
/**
...
export declare class PackagingApi extends BaseAPI {
     ...
     */
    packagingCreate(xRMGAuthToken: string, packaging: Packaging, options?: any): Promise<import("axios").AxiosResponse<PackagingResponse>>;
    /**
     * Deletes the specified packaging.
     * @summary Delete Packaging
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @memberof PackagingApi
     */
    packagingDelete(xRMGAuthToken: string, packagingId: string, options?: any): Promise<import("axios").AxiosResponse<PackagingResponse>>;
    /**
     * Get the packaging details specified by your unique Packaging ID.
     * @summary Get Packaging
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @memberof PackagingApi
     */
    packagingGet(xRMGAuthToken: string, packagingId: string, options?: any): Promise<import("axios").AxiosResponse<Packaging>>;
    /**
     * Get all of your stored packaging details
     * @summary Get All Packaging
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @memberof PackagingApi
     */
    packagingGetAll(xRMGAuthToken: string, options?: any): Promise<import("axios").AxiosResponse<Packaging[]>>;
    /**
     * Update packaging details that is already stored with new details. All details will be replaced with new details.
     * @summary Update packaging
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @memberof PackagingApi
     */
    packagingUpdate(xRMGAuthToken: string, packagingId: string, packaging: Packaging, options?: any): Promise<import("axios").AxiosResponse<PackagingResponse>>;
}
/**
...
export declare const ShipmentsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    shipmentsCancel: (xRMGAuthToken: string, shipmentCancelRequests: Array<ShipmentCancelRequest>, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    shipmentsCreate: (xRMGAuthToken: string, shipment: CreateShipmentShipment, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    shipmentsDefer: (xRMGAuthToken: string, shipmentDeferRequests: Array<ShipmentDeferRequest>, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    shipmentsHold: (xRMGAuthToken: string, shipmentHoldRequests: Array<ShipmentHoldRequest>, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    shipmentsPrintDocument: (xRMGAuthToken: string, shipmentId: string, printDocumentRequest: PrintDocumentRequest, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    shipmentsPrintLabel: (xRMGAuthToken: string, shipmentId: string, printLabelRequest: PrintLabelRequest, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    shipmentsRelease: (xRMGAuthToken: string, shipmentsReleaseRequest: ShipmentsReleaseRequest, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    shipmentsServiceAvailability: (xRMGAuthToken: string, shipment: ServiceAvailabilityShipment, options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const ShipmentsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    shipmentsCancel(xRMGAuthToken: string, shipmentCancelRequests: Array<ShipmentCancelRequest>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ShipmentsCancelResponse>>;
    /**
     * Use to generate the final delivery label for your packages.<br />            <br />The request is split into several sections:<br />            <br />**Shipper** - who and where the parcel is coming from - optional if the posting location is to be used.<br />**Destination** - who and where the parcel is going to.<br />**Shipment Information** - overall package details, individual item details and requested service information.
     * @summary Create Shipment
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @throws {RequiredError}
     */
    shipmentsCreate(xRMGAuthToken: string, shipment: CreateShipmentShipment, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ShipmentCreateResponse>>;
    /**
     * Used to update the shipment shipping date for a current shipment.<br />A shipment can be deferred by a maximum of 28 days from the date of the request.<br />This service can only be used before the shipment has been confirmed either by calling the manifest create request or by closing out via the User Interface.<br />There can be a maximum of 99 defer requests per call.
     * @summary Defer Shipments
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @throws {RequiredError}
     */
    shipmentsDefer(xRMGAuthToken: string, shipmentDeferRequests: Array<ShipmentDeferRequest>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ShipmentsDeferResponse>>;
    /**
     * Used to put a shipment on hold indefinitely.<br />A shipment on hold will not be included in any closeouts, but instead will remain in its current state.<br />Calling printLabel will release the shipment from being held.<br />This service can only be used before the shipment has been confirmed either by calling the manifest create request or by closing out via the User Interface.<br />            <br />A hold reason must be provided and must match those set in Pro Shipping under your maintenance screens.<br />If no hold reasons exist, then shipments cannot be put on hold.<br />            <br />There can be a maximum of 99 hold requests per call.
     * @summary Hold Shipments
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @throws {RequiredError}
     */
    shipmentsHold(xRMGAuthToken: string, shipmentHoldRequests: Array<ShipmentHoldRequest>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ShipmentsHoldResponse>>;
    /**
     * Prints the requested document for the shipment.<br />If item information, description of goods or reason for export have not been provided then the document cannot be printed.<br />            <br />This service can only be used before the shipment has been confirmed either by calling the manifest create request or by closing out via the User Interface.
     * @summary Print Document
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @throws {RequiredError}
     */
    shipmentsPrintDocument(xRMGAuthToken: string, shipmentId: string, printDocumentRequest: PrintDocumentRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PrintDocumentResponse>>;
    /**
     * Prints the label for the shipment.<br />Moves the shipment to processed, ready to manifest, if the shipment was not already in a processed state.<br />This service can only be used before the shipment has been confirmed either by calling the manifest create request or by closing out via the User Interface.<br />**On Hold Shipment**<br />Calling print label on a held shipment will release the shipment from hold and update the shipment date to today.
     * @summary Print Label
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @throws {RequiredError}
     */
    shipmentsPrintLabel(xRMGAuthToken: string, shipmentId: string, printLabelRequest: PrintLabelRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PrintLabelResponse>>;
    /**
     * Used to release a shipment from being on hold.<br />This service can only be used for shipments on hold.<br />            <br />Releasing a shipment from hold will update the shipment date to today\'s date and if the shipment is processed it will be included the next requested manifest.<br />            <br />There can be a maximum of 99 release requests per call.
     * @summary Release Shipments
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @throws {RequiredError}
     */
    shipmentsRelease(xRMGAuthToken: string, shipmentsReleaseRequest: ShipmentsReleaseRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ShipmentsReleaseResponse>>;
    /**
     * Retrieve a list of available services for a potential shipment.<br />            <br />**Destination** - where the parcel is going to.<br />**Shipment Information** - overall package details and requested service requirements.
     * @summary Service Availability
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @throws {RequiredError}
     */
    shipmentsServiceAvailability(xRMGAuthToken: string, shipment: ServiceAvailabilityShipment, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ServiceAvailabilityResponse>>;
};
/**
...
export declare class ShipmentsApi extends BaseAPI {
     ...
     */
    shipmentsCancel(xRMGAuthToken: string, shipmentCancelRequests: Array<ShipmentCancelRequest>, options?: any): Promise<import("axios").AxiosResponse<ShipmentsCancelResponse>>;
    /**
     * Use to generate the final delivery label for your packages.<br />            <br />The request is split into several sections:<br />            <br />**Shipper** - who and where the parcel is coming from - optional if the posting location is to be used.<br />**Destination** - who and where the parcel is going to.<br />**Shipment Information** - overall package details, individual item details and requested service information.
     * @summary Create Shipment
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @memberof ShipmentsApi
     */
    shipmentsCreate(xRMGAuthToken: string, shipment: CreateShipmentShipment, options?: any): Promise<import("axios").AxiosResponse<ShipmentCreateResponse>>;
    /**
     * Used to update the shipment shipping date for a current shipment.<br />A shipment can be deferred by a maximum of 28 days from the date of the request.<br />This service can only be used before the shipment has been confirmed either by calling the manifest create request or by closing out via the User Interface.<br />There can be a maximum of 99 defer requests per call.
     * @summary Defer Shipments
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @memberof ShipmentsApi
     */
    shipmentsDefer(xRMGAuthToken: string, shipmentDeferRequests: Array<ShipmentDeferRequest>, options?: any): Promise<import("axios").AxiosResponse<ShipmentsDeferResponse>>;
    /**
     * Used to put a shipment on hold indefinitely.<br />A shipment on hold will not be included in any closeouts, but instead will remain in its current state.<br />Calling printLabel will release the shipment from being held.<br />This service can only be used before the shipment has been confirmed either by calling the manifest create request or by closing out via the User Interface.<br />            <br />A hold reason must be provided and must match those set in Pro Shipping under your maintenance screens.<br />If no hold reasons exist, then shipments cannot be put on hold.<br />            <br />There can be a maximum of 99 hold requests per call.
     * @summary Hold Shipments
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @memberof ShipmentsApi
     */
    shipmentsHold(xRMGAuthToken: string, shipmentHoldRequests: Array<ShipmentHoldRequest>, options?: any): Promise<import("axios").AxiosResponse<ShipmentsHoldResponse>>;
    /**
     * Prints the requested document for the shipment.<br />If item information, description of goods or reason for export have not been provided then the document cannot be printed.<br />            <br />This service can only be used before the shipment has been confirmed either by calling the manifest create request or by closing out via the User Interface.
     * @summary Print Document
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @memberof ShipmentsApi
     */
    shipmentsPrintDocument(xRMGAuthToken: string, shipmentId: string, printDocumentRequest: PrintDocumentRequest, options?: any): Promise<import("axios").AxiosResponse<PrintDocumentResponse>>;
    /**
     * Prints the label for the shipment.<br />Moves the shipment to processed, ready to manifest, if the shipment was not already in a processed state.<br />This service can only be used before the shipment has been confirmed either by calling the manifest create request or by closing out via the User Interface.<br />**On Hold Shipment**<br />Calling print label on a held shipment will release the shipment from hold and update the shipment date to today.
     * @summary Print Label
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @memberof ShipmentsApi
     */
    shipmentsPrintLabel(xRMGAuthToken: string, shipmentId: string, printLabelRequest: PrintLabelRequest, options?: any): Promise<import("axios").AxiosResponse<PrintLabelResponse>>;
    /**
     * Used to release a shipment from being on hold.<br />This service can only be used for shipments on hold.<br />            <br />Releasing a shipment from hold will update the shipment date to today\'s date and if the shipment is processed it will be included the next requested manifest.<br />            <br />There can be a maximum of 99 release requests per call.
     * @summary Release Shipments
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @memberof ShipmentsApi
     */
    shipmentsRelease(xRMGAuthToken: string, shipmentsReleaseRequest: ShipmentsReleaseRequest, options?: any): Promise<import("axios").AxiosResponse<ShipmentsReleaseResponse>>;
    /**
     * Retrieve a list of available services for a potential shipment.<br />            <br />**Destination** - where the parcel is going to.<br />**Shipment Information** - overall package details and requested service requirements.
     * @summary Service Availability
     * @param {string} xRMGAuthToken Authorisation token required to invoke this operation. Can be retrieved by invoking the **_/token** operation.
     ...
     * @memberof ShipmentsApi
     */
    shipmentsServiceAvailability(xRMGAuthToken: string, shipment: ServiceAvailabilityShipment, options?: any): Promise<import("axios").AxiosResponse<ServiceAvailabilityResponse>>;
}
/**
...
export declare const TokenApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    authenticatePost: (xRMGSecurityUsername: string, xRMGSecurityPassword: string, options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const TokenApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    authenticatePost(xRMGSecurityUsername: string, xRMGSecurityPassword: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
};
/**
...
export declare class TokenApi extends BaseAPI {
     ...
     * @memberof TokenApi
     */
    authenticatePost(xRMGSecurityUsername: string, xRMGSecurityPassword: string, options?: any): Promise<import("axios").AxiosResponse<void>>;
}
